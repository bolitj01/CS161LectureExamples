...
public class GridEscape {
    ...
    public static void main(String[] args) {
        GridEntity player = new GridEntity(START_X, START_Y);
        GridEntity exit = randomEmpty(START_X, START_Y);
        GridEntity monster;
    ...
    /*
    TODO Write a method that creates a GridEntity at a random empty
         position that is not at x or y
     */
    private static GridEntity randomEmpty(int x, int y) {

    }

    //Debug method to print the grid
    private static void printGrid(GridEntity player, GridEntity monster, GridEntity exit) {
